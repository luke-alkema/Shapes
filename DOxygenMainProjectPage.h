...
/// shapes. As well as their own behaviors like showing information and the virtual functions mentioned above. You can also use various overloaded operators in the specific shapes. 
/// 
/// \section Shape
...
/// Not all shapes have sides (e.g. circle), so this is a special attribute just for square. We added some overloaded operators to add, multiply, assign, and check if the squares are equal.
///
/// \section GitHub
/// - <A target=blank HREF="https://github.com/LukeleLegend/Shapes"> GitHub Shapes Repository </A>
